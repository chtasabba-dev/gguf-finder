...
export default function Home() {
  ...
  const suitability = repository ? getPcSuitability(detectParameterSize(repository.metadata.id), pcProfile.ramGb) : null;
